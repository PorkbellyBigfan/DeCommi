...
// diaryService.getDiaryPostList(requestDTO);
...
// List<LikeTagList> result =
// likeTagListRepository.getLikeTagList(member.getMid());
// log.info(result);
// }
// // @Test
...
// replyRepository.getLastestReplyGroupWhereMatchWithDino(diary.getDino());
// Long setrg = 1L;
...
// Diary diary = Diary.builder().dino(1L).build();
// Reply reply =
// Reply.builder().dino(diary).member(member).replyGroup(1L).replyDepth(1L)
