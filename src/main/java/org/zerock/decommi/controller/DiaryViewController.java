...
public class DiaryViewController {
  ...
  public ResponseEntity<List<DiaryPostList>> getDiaryList(@ModelAttribute SearchCondition searchCondition) {
    return new ResponseEntity<>(diaryService.getDiaryPostList(searchCondition), HttpStatus.OK);
  }
