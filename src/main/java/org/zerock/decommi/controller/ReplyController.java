...
import org.zerock.decommi.service.ReplyService;
...
public class ReplyController {
  ...
  @GetMapping(value = "/diary/{dino}", produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<List<ReplyDTO>> getListByDiary(@PathVariable("dino") Long dino) {
    log.info("dino:" + dino);
